...
const MainPageComponent = (props) => {
    ...
    return(<View>
        <Text>Ici la liste des différents produits</Text>


            <TouchableOpacity style={{margin:5,padding:5,flexDirection:"row",borderRadius:15,borderWidth:0.5, height:'30%'}} onPress={goToArVisualisation}>
                <Text>Item à cliquer</Text>
                <Image
                ...
                <View style={{flexDirection:"row"}}>
                    <Text>Modèle : </Text>
                    <Text>Nom du modèle</Text>
                </View>

            </TouchableOpacity>
        <TouchableOpacity style={{margin:5,padding:5,borderRadius:15,borderWidth:0.5}} onPress={goToScanner}>
                <Text>Item à cliquer</Text>
                <Image
                    style={styles.tinyLogo}
                    source={{
