...
import {BASE_API_URL_PRODUCT, BASE_API_PORT_PRODUCT} from '../config';
...
const DetailProductComponent = props => {
  ...
  function api() {
    return new Promise((resolve, reject) => {
      fetch(
        BASE_API_URL_PRODUCT +
          ':' +
          BASE_API_PORT_PRODUCT +
          '/api/products/' +
    ...
    return (
      <View style={styles.product}>
        <View style={styles.titleUnderline}>
          <Text style={styles.titleName}>Nom du produit </Text>
        </View>
        <Text
          style={{
            fontSize: 22,
